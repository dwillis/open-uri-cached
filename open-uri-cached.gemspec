Gem::Specification.new do |s|
  ...
  s.version = '0.0.1'
  s.email = 'srushe@gmail.com'
  s.homepage = 'http://github.com/srushe/open-uri-cached'
  s.description = 'OpenURI with transparent disk caching'
  s.authors = ['Danial Pearce', 'Derek Willis', 'Stephen Rushe']
  ...
  s.files = %w(README.markdown LICENSE lib/open-uri/cached.rb)
end
